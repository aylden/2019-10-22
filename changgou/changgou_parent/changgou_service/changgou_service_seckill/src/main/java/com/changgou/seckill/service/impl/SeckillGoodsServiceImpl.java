...
public class SeckillGoodsServiceImpl implements SeckillGoodsService {
    ...
    @Override
    public List<SeckillGoods> getSeckillGoodsList(String timearea) {
        List<SeckillGoods> seckillGoodsList = redisTemplate.boundHashOps("SeckillGoods_" + timearea).values();
        return seckillGoodsList;
    }

    @Override
    public SeckillGoods getSeckillGoods(long id, String timearea) {
        SeckillGoods seckillGoods = (SeckillGoods) redisTemplate.boundHashOps("SeckillGoods_" + timearea).get(id);
        return seckillGoods;
    }
}
