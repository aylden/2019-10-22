...
public interface SeckillOrderFeign {
    ...
    Result<PageInfo> findPage(@RequestBody(required = false) SeckillOrder seckillOrder, @PathVariable(value = "page") int page, @PathVariable(value = "size") int size);
     ...
     */
    @PutMapping(value = "/{id}")
    Result update(@RequestBody SeckillOrder seckillOrder, @PathVariable(value = "id") Long id);
     ...
     */
    @GetMapping("/{id}")
    Result<SeckillOrder> findById(@PathVariable(value = "id") Long id);
